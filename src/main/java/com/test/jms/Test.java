...
public class Test {
	...
	public static void main(String[] args) {
		...
		for (String string : timezon) {
			System.out.println(string);
		}*/
		
		String num1= RandomNumberGenerator.generateNumber();
		String num2 = RandomNumberGenerator.generateNumber2();
	...
	/*	String timeData = "{
				...
				‘South America      中南美洲’: {   //------------------------------------------
					...
					‘New Calednia       新克里多尼亚’:[‘+1100’,’’,’努美阿’],
					‘New Guined         巴布新几内亚’:[‘+1000’,’’,’莫尔兹比港’],
