...
function getPro(URLL,model_id){
    $('#cgdata').datagrid({
        width:'800px',
        height:'400px', 
		url:URLL+'/deviceModel/gerPro',
		fitColumns:true,
	    method: 'POST',
	    loadMsg:'数据加载中请稍后……',  
	    striped: true,
	  ...
	  scrollbarSize :0,
		...
		columns:[
		         [
		        {field:'id',title:'属性ID',align: 'center', width:'200px'},
...
function getModelDevPro(URLL,model_id){
          $('#cgdata').datagrid({
              view: detailview,
              ...
              onExpandRow: function(index,row){
            	  ...
            	  if (row.property==null) {
					  ...
					  ddv.datagrid({
		       	            ...
		       	            loadMsg:'',   
		       	            height:'auto',  
		       	           url:URLL+'/property/getProChan?property_id='+row.id,
		       	           columns:[[
		       	                     {field:'name',title:'通道名称',align: 'center', width:'200px'},
									{field:'alias',title:'通道别名',align: 'center', width:'200px'},
									{field:'description',title:'通道描述',align: 'center', width:'200px'},
									{field:'channel_type',title:'channel_type',align: 'center', width:'200px'},
		       	                  {field:'created_at',title:'创建时间',formatter: formatDatebox,align: 'center', width:'200px'}
		      		             ]],
		           	           onResize:function(){   
